...
$cod=$_POST["cod_c"];
$re=pg_query($db,"UPDATE carrer SET active=true WHERE cod_carrer='$cod'");
$data_sen=pg_query($db,"SELECT * FROM carrer WHERE cod_carrer='$cod'");
...
<div class="container">
  <h2>Carrera Reactivada</h2>
  <div class="panel panel-default">
    <div class="panel-body">
      La carrera <?php echo $data['name'];?> ha sido re-activada exitosamente.
    </div>
  </div>
</div>
